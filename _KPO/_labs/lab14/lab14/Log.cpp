...
namespace Log {
	//функция отвечающая за создание и открытие файла протокола
	...
	//функция для записи символьных строк в поток протокола
	...
	//перегруженная функция для записи широких строк в поток протокола
