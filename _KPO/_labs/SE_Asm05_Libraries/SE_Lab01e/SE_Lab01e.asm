; Используется формат MASM для архитектуры x86 (.586)
.MODEL FLAT, STDCALL
...
; Внешние символы (прототипы) функций
EXTRN getmin : proc
EXTRN getmax : proc
...
.DATA
Array		DWORD	 2, 3, 4, 5,1, 6, 8, 9, -10       ; Массив чисел
...
START :
	...
	push LENGTHOF Array   ; Параметр: количество элементов в массиве
	push OFFSET Array     ; Параметр: адрес начала массива
	call getmax; Вызов функции getmax для поиска максимального значения в массиве
